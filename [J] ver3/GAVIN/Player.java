...
public class Player implements DrawingObject{
    ...
    public Player(int ID, int xCoordinate, int yCoordinate, int tileSize, int speed, KeyHandler keyH, AllCanvas ac){
        this.ID = ID;
    ...
    public void moveCoinGame(){
        // PLAYER WILL MOVE IF COLLISION IS FALSE
        allCanvas.SOM.coinScreen.ccc.checkPlace(this);
