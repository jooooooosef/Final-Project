...
public class CoinScreen implements DrawingObject{
    ...
    public CoinScreen(int width, int height){
        ...
        ccc = new CoinCollisionChecker(this);
        getFloorTile();
        getBackground();
    }
    ...
    public void getFloorTile(){
        try {
            floorDown = ImageIO.read(getClass().getResourceAsStream("/floor128.png"));
            floorUp = ImageIO.read(getClass().getResourceAsStream("/floor128U.png"));
        } catch (IOException e){
